...
values('Сыр плавленный', 1, date '10.05.2022', 50), 
('Сыр моцарелла', 1, date '12.05.2022', 60), 
('Сыр сливочный', 1, date '01.05.2022', 20);
insert into product(name, type_id, expired_date, price) 
values('Пискаревское', 2, date '09.05.2022', 66), 
('Домик в деревне', 2, date '29.04.2022', 70);
insert into product(name, type_id, expired_date, price) 
values('Эскимо мороженое', 3, date '20.05.2022', 89), 
('Пломбир', 3, date '29.06.2022', 90), 
('Лакомка мороженое', 3, date '08.07.2022', 120);
insert into product(name, type_id, expired_date, price) 
